# Lautaro De Gyldenfeldt

**Data Scientist** · Buenos Aires, Argentina

I build end-to-end data science and machine learning projects — from raw data ingestion and feature engineering through model training and production-ready inference. My work spans market microstructure, combinatorial optimization, topological data analysis, and NLP/LLM systems.

I care about clean problem formulations, reproducible pipelines, and writing code that someone else can read six months later.
...
| [**nyc-taxi-analitics**](https://github.com/Gyldenn/nyc-taxi-analytics) | End-to-end PySpark + Spark SQL analytics pipeline on NYC Yellow Taxi data (Jan 2024) — zone demand, peak hours, fare anomaly detection, route analysis | PySpark · SQL · python|
...
I'm a data science student based in Buenos Aires. My background combines strong algorithmic foundations (competitive programming, optimization) with applied machine learning on real-world data. I'm looking for opportunities as a **Data Analyst** or **Data Scientist** where I can contribute to projects that involve quantitative analysis, predictive modeling, and data-driven decision making.

---

### Contact

📫 **degyldenfeldtlautaro@gmail.com**  
🔗 [github.com/Gyldenn](https://github.com/Gyldenn)
<!---
